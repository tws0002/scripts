...
(function( root, factory ) {
	...
	function showHelp() {
		...
		if( config.help ) {
			...
			dom.overlay.innerHTML = [
				'<header>',
	                '<div class="right-button"><a><i class="fa fa-times-circle animated infinite pulse"></i></a></div>',
			...
			dom.overlay.querySelector( '.right-button' ).addEventListener( 'click', function( event ) {
				closeOverlay();
				event.preventDefault();
			}, false );
	...
	function Playback( container, progressCheck ) {
		...
		this.container = document.querySelector( '.play-button' );
	...
	Playback.prototype.render = function() {
		...
		if( this.playing ) {
			...
			this.context.lineWidth = this.thickness;
			this.context.strokeStyle = '#42affa';
			this.context.stroke();
		}
