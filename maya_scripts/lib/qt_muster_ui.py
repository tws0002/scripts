...
# Form implementation generated from reading ui file '//Art-1405260002/d/assets/scripts/maya_scripts/ui/qt_muster_submit.ui'
#
# Created: Mon May 25 15:13:26 2015
...
class Ui_MusterConnector(object):
    def setupUi(self, MusterConnector):
        ...
        MusterConnector.resize(400, 594)
        ...
        self.render_pool_layout = QtGui.QHBoxLayout()
        self.render_pool_layout.setSpacing(15)
        self.render_pool_layout.setSizeConstraint(QtGui.QLayout.SetDefaultConstraint)
        self.render_pool_layout.setObjectName("render_pool_layout")
        self.render_pool_label = QtGui.QLabel(self.submit_panel)
        self.render_pool_label.setMinimumSize(QtCore.QSize(80, 0))
        self.render_pool_label.setMaximumSize(QtCore.QSize(80, 16777215))
        self.render_pool_label.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.render_pool_layout.addWidget(self.render_pool_label)
        self.render_pool = QtGui.QComboBox(self.submit_panel)
        self.render_pool.setObjectName("render_pool")
        self.render_pool_layout.addWidget(self.render_pool)
        self.refresh_muster_pool = QtGui.QPushButton(self.submit_panel)
        self.refresh_muster_pool.setMinimumSize(QtCore.QSize(22, 22))
        self.refresh_muster_pool.setMaximumSize(QtCore.QSize(22, 22))
        self.refresh_muster_pool.setText("")
        icon3 = QtGui.QIcon()
        ...
        self.refresh_muster_pool.setIcon(icon3)
        self.refresh_muster_pool.setObjectName("refresh_muster_pool")
        self.render_pool_layout.addWidget(self.refresh_muster_pool)
        self.verticalLayout_4.addLayout(self.render_pool_layout)
        self.submit_button_layout = QtGui.QHBoxLayout()
        self.submit_button_layout.setSpacing(10)
        self.submit_button_layout.setContentsMargins(41, 10, -1, 10)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/send-o_c8c8c8_12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.submit_render_button.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/nuke_scripts/icons/Write1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/nuke_scripts/icons/Write.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.nuke_panel_button.setIcon(icon5)
    ...
    def retranslateUi(self, MusterConnector):
        ...
        self.render_pool_label.setText(QtGui.QApplication.translate("MusterConnector", "Render Pool", None, QtGui.QApplication.UnicodeUTF8))
