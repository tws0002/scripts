...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.colorCodeButton.setSpacing(0)
        self.colorCodeButton.setContentsMargins(-1, 0, -1, 0)
        self.colorCodeButton.setObjectName("colorCodeButton")
        self.filter_character = QtGui.QPushButton(self.assets_tab)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/filter_character.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_character.setIcon(icon4)
        self.filter_character.setFlat(False)
        self.filter_character.setObjectName("filter_character")
        self.colorCodeButton.addWidget(self.filter_character)
        self.filter_vehicle = QtGui.QPushButton(self.assets_tab)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/filter_vehicle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_vehicle.setIcon(icon5)
        self.filter_vehicle.setObjectName("filter_vehicle")
        self.colorCodeButton.addWidget(self.filter_vehicle)
        self.filter_prop = QtGui.QPushButton(self.assets_tab)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/filter_prop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_prop.setIcon(icon6)
        self.filter_prop.setObjectName("filter_prop")
        self.colorCodeButton.addWidget(self.filter_prop)
        self.filter_sets = QtGui.QPushButton(self.assets_tab)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/filter_set.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_sets.setIcon(icon7)
        self.filter_sets.setObjectName("filter_sets")
        self.colorCodeButton.addWidget(self.filter_sets)
        self.filter_other = QtGui.QPushButton(self.assets_tab)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/filter_other.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_other.setIcon(icon8)
        self.filter_other.setObjectName("filter_other")
        self.colorCodeButton.addWidget(self.filter_other)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/sign-out_222222_12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/folder-open-o_222222_12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_path_button.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("//Art-1405260002/d/assets/scripts/maya_scripts/icons/save_222222_12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
